...
\epigraph{\textit{"When I started secondary school, it was assumed that the girls would do domestic science and the boys would do science, and I wasn't too happy with that."}}{Jocelyn Bell Burnell}
